# Generated by Django 4.2.7 on 2025-07-05 12:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_comment', models.TextField(blank=True, null=True, verbose_name='Комментарии к доставке')),
                ('delivery_price', models.DecimalField(decimal_places=2, default=0, max_digits=7, verbose_name='Стоимость доставки')),
                ('payment_on_get', models.BooleanField(default=False, verbose_name='Оплата при получении')),
                ('is_paid', models.BooleanField(default=False, verbose_name='Оплачено')),
                ('status', models.CharField(choices=[('processing', 'В обработке'), ('confirmed', 'Принят в работу'), ('completed', 'Выполнен'), ('canceled', 'Отменен')], default='processing', max_length=20, verbose_name='Статус заказа')),
